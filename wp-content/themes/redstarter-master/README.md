...
A WordPress theme created for the purpose of exploring how to create a custom theme. Project 5 for the Web Development Professional Program at RED Academy.

#Author
Mia Salaveria

#Findings
Learned how to create a custom theme on Wordpress using PHP, WP-ADMIN, and built in Wordpress functions. Learned how to maximize the dynamic abilities of a theme.
